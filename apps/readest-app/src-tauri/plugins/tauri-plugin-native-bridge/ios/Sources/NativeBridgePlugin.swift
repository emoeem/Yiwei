...
class NativeBridgePlugin: Plugin {
  ...
  /// `group.com.yiwei.reader`. Two directions on every activation:
  ///
  ...
  private static let syncKeychainService = "com.yiwei.reader.sync-passphrase"
  ...
  private static let secureItemsService = "com.yiwei.reader.secure-items"
  ...
  /// entitlements, iCloud.com.yiwei.reader) and ensure Documents/ exists.
